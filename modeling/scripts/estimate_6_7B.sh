...
./scripts/estimate.sh 0 6_7B 8 2 2 1 1 > ../results/estimate/6_7B/test_4.txt
./scripts/estimate.sh 0 6_7B 8 1 2 2 1 > ../results/estimate/6_7B/test_5.txt
./scripts/estimate.sh 0 6_7B 8 1 1 4 1 > ../results/estimate/6_7B/test_6.txt
./scripts/estimate.sh 0 6_7B 8 1 4 1 1 > ../results/estimate/6_7B/test_7.txt